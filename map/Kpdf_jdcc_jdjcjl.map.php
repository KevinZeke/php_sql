...
class Kpdf_jdcc_jdjcjl_map extends DB_map {
  static $table_name = 'kpdf_jdcc_jdjcjl' ;
  ...
  static $jdcc_jdjcjl_c = 'kpdf_jdcc_jdjcjl.jdcc_jdjcjl_c' ;
  static $jdcc_jdjcjl_d = 'kpdf_jdcc_jdjcjl.jdcc_jdjcjl_d' ;
