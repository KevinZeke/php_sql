...
class Kpdf_xzcf_sdhz_map extends DB_map {
  static $table_name = 'kpdf_xzcf_sdhz' ;
  ...
  static $xzcf_sdhz_c = 'kpdf_xzcf_sdhz.xzcf_sdhz_c' ;
  static $xzcf_sdhz_d = 'kpdf_xzcf_sdhz.xzcf_sdhz_d' ;
