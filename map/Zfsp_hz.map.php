...
class Zfsp_hz_map extends DB_map {
  ...
  static $zfsp_xzqz = 'zfsp_hz.zfsp_xzqz' ;
  ...
  static $zfsp_xzqz_truescore = 'zfsp_hz.zfsp_xzqz_truescore' ;
  ...
  static $xzqz_lxqz = 'zfsp_hz.xzqz_lxqz' ;
  ...
  static $xzqz_count = 'zfsp_hz.xzqz_count' ;
  static function all(){
            //return parent::all();
        }
}
