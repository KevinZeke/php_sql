...
class Zfzl_jsys_score_map extends DB_map {
  static $table_name = 'zfzl_jsys_score' ;
  static $name = 'zfzl_jsys_score.name' ;
  static $zhidui = 'zfzl_jsys_score.zhidui' ;
  static $dadui = 'zfzl_jsys_score.dadui' ;
