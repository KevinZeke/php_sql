...
//};
    ...
    Efficiency::count_hzdc_fh_by_date($sqltool, $data_arr, function ($row) use (&$dadui_huizong_sql, &$hzdc_fh_sql, &$hz_sql) {
        Efficiency::row_handel($row, $dadui_huizong_sql, $hzdc_fh_sql, $hz_sql, 'hzdc_fh');
    });
