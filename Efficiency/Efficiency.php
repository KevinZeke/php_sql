...
require_once __DIR__ . '/../map/Zfxl_xzqz.map.php';
...
//        $sqltool_zxpg->close();
        ...
        $score = Efficiency::coef_count(
            $type == 'hzdc_fh' ? 'hzdc' : $type, $clbz['score'],
            $param, $son
        );

        $lx_coef = Efficiency::field_coef_get(
            $type == 'hzdc_fh' ? 'hzdc' : $type, $param, $son
        );
        ...
        if ($type == 'xzcf') {
            ...
            $xl_hz_sql .= Sql_tool::format_insert_value(
                [
                    ...
                    self::$coef['xzqz'],//Zfxl_hz_map::$xzqz_lxqz
...
//                    Sql_tool::QUOTE($row[Field_map::$proeject_type]), //xmlx
                ...
                $xl_hz_sql .= Sql_tool::format_insert_value(
                    [
                        ...
                        self::$coef['bacc'],//Zfxl_hz_map::$bacc_lxqz,
                        self::$coef['hzdc'],//Zfxl_hz_map::$hzdc_lxqz
                        self::$coef['xzcf']//Zfxl_hz_map::$hzdc_lxqz
                        ,
                        0,//Zfxl_hz_map::$hzdc_count,
                        0,//Zfxl_hz_map::$xzcf_count,
                        0,//Zfxl_hz_map::$bacc_count,
...
//                    Gzpc_xmxx_jdjc_map::$overTime => Field_map::$over_time,
                ...
                'AND (sonType = \'强制执行\' or sonType = \'临时查封\') '
                . $param
            )->each_row($callback);
    }
...
//                    Gzpc_xmxx_aqjc_map::$overTime => Field_map::$over_time,
    ...
    public static function xzqz_clear($db, $date = null)
    {
        $sqlTool = parent::sqlTool_build($db);
        $tables = [
            new Table(Zfxl_xzqz_map::$table_name, $sqlTool)
        ];
        ...
        $res = $hz_table
            ->group_query(
                [
                    ...
                    Sql_tool::SUM(Zfxl_hz_map::$zfxl_xzqz) => 'xzqz_',
                    ...
                    Sql_tool::SUM(Zfxl_hz_map::$zfxl_xzqz_truescore) => 'xzqz',
                    Zfxl_hz_map::$name => 'n',
                    Zfxl_hz_map::$SJ => 'y',
                    Zfxl_hz_map::$dadui => 'd',
                    ...
                    Sql_tool::SUM(Zfxl_hz_map::$xzqz_count) => 'xzqz_c'
                ],
                [
                    Zfxl_hz_map::$name,
                    Zfxl_hz_map::$SJ,
